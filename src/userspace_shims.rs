...
pub mod proc {
    pub mod exec {
        ...
        const USER_STACK_TOP: usize = 0x0000_007F_FFFF_F000;
        ...
        mod aarch64_user_entry {
            ...
            pub fn build_address_space(
                ...
                super::aarch64_log("aarch64-userspace: clone ttbr0");
                ...
                super::aarch64_log("aarch64-userspace: install user mappings");
                for mapping in mappings {
                    match mapping.kind {
                ...
                super::aarch64_log("aarch64-userspace: address space ready");
                Ok(ttbr0)
            }
            ...
            fn handle_svc(frame: &mut Aarch64BootFrame) {
                ...
                frame.x[0] = result;
                // AArch64 records the post-SVC return address in ELR_EL1 for
                // this EL0 exception path, so returning the saved ELR resumes
                // at the instruction after `svc #0`.  Advancing it here would
                // skip the userspace write_all() accounting instruction and
                // cause the first write syscall to loop forever.
            }
