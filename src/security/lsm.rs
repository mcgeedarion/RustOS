...
pub trait LsmHooks: Send + Sync {
    ...
    fn task_create(&self, ctx: &LsmCtx) -> LsmVerdict {
        LsmVerdict::Allow
    }
    ...
    fn socket_connect(&self, ctx: &LsmCtx) -> LsmVerdict {
        LsmVerdict::Allow
    }
    fn socket_bind(&self, ctx: &LsmCtx) -> LsmVerdict {
        LsmVerdict::Allow
    }
    fn socket_accept(&self, ctx: &LsmCtx) -> LsmVerdict {
        LsmVerdict::Allow
    }
